...
class PatchParition(tf.keras.layers.Layer):
    ...
    It takes the input of size (B, H, W, C) and turn into ( B, (H*W)//(P*P), (P*P*C) ), where P is the patch size or window size
    '''
    ...
    def call(self, images):
        ...
        patches = tf.reshape(patches, [batch_size, -1, patch_dims]) # ( B, (H*W)//(P*P), (P*P*C) )
        return patches
